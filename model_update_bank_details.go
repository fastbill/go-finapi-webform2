...
func (v NullableUpdateBankDetails) Get() *UpdateBankDetails {
	return v.value
}

func (v *NullableUpdateBankDetails) Set(val *UpdateBankDetails) {
	v.value = val
	v.isSet = true
}
...
func NewNullableUpdateBankDetails(val *UpdateBankDetails) *NullableUpdateBankDetails {
	return &NullableUpdateBankDetails{value: val, isSet: true}
}
