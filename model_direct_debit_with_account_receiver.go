...
func NewDirectDebitWithAccountReceiver(accountId int64) *DirectDebitWithAccountReceiver {
	this := DirectDebitWithAccountReceiver{}
...
type NullableDirectDebitWithAccountReceiver struct {
	value *DirectDebitWithAccountReceiver
	isSet bool
}

func (v NullableDirectDebitWithAccountReceiver) Get() *DirectDebitWithAccountReceiver {
	return v.value
}

func (v *NullableDirectDebitWithAccountReceiver) Set(val *DirectDebitWithAccountReceiver) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectDebitWithAccountReceiver) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectDebitWithAccountReceiver) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectDebitWithAccountReceiver(val *DirectDebitWithAccountReceiver) *NullableDirectDebitWithAccountReceiver {
	return &NullableDirectDebitWithAccountReceiver{value: val, isSet: true}
}
