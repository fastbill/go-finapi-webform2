...
type NullableInvalidFieldError struct {
	value *InvalidFieldError
	isSet bool
}

func (v NullableInvalidFieldError) Get() *InvalidFieldError {
	return v.value
}

func (v *NullableInvalidFieldError) Set(val *InvalidFieldError) {
	v.value = val
	v.isSet = true
}
...
func NewNullableInvalidFieldError(val *InvalidFieldError) *NullableInvalidFieldError {
	return &NullableInvalidFieldError{value: val, isSet: true}
}
