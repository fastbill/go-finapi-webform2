...
type NullableCreateProfileDetails struct {
	value *CreateProfileDetails
	isSet bool
}

func (v NullableCreateProfileDetails) Get() *CreateProfileDetails {
	return v.value
}

func (v *NullableCreateProfileDetails) Set(val *CreateProfileDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateProfileDetails) IsSet() bool {
	return v.isSet
}
...
func NewNullableCreateProfileDetails(val *CreateProfileDetails) *NullableCreateProfileDetails {
	return &NullableCreateProfileDetails{value: val, isSet: true}
}
