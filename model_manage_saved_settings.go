...
func (v *ManageSavedSettings) UnmarshalJSON(src []byte) error {
	...
	enumTypeValue := ManageSavedSettings(value)
	for _, existing := range AllowedManageSavedSettingsEnumValues {
	...
	return fmt.Errorf("%+v is not a valid ManageSavedSettings", value)
}

// NewManageSavedSettingsFromValue returns a pointer to a valid ManageSavedSettings
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewManageSavedSettingsFromValue(v string) (*ManageSavedSettings, error) {
	ev := ManageSavedSettings(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for ManageSavedSettings: valid values are %v", v, AllowedManageSavedSettingsEnumValues)
	}
}
...
func (v ManageSavedSettings) Ptr() *ManageSavedSettings {
	return &v
}

type NullableManageSavedSettings struct {
	value *ManageSavedSettings
	isSet bool
}

func (v NullableManageSavedSettings) Get() *ManageSavedSettings {
	return v.value
}

func (v *NullableManageSavedSettings) Set(val *ManageSavedSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableManageSavedSettings) IsSet() bool {
	return v.isSet
}
...
func NewNullableManageSavedSettings(val *ManageSavedSettings) *NullableManageSavedSettings {
	return &NullableManageSavedSettings{value: val, isSet: true}
}
