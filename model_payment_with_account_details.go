...
func NewPaymentWithAccountDetails(sender PaymentWithAccountSender, orders []PaymentOrder) *PaymentWithAccountDetails {
	this := PaymentWithAccountDetails{}
...
func (o *PaymentWithAccountDetails) GetSender() PaymentWithAccountSender {
	if o == nil {
		var ret PaymentWithAccountSender
		return ret
	}
...
type NullablePaymentWithAccountDetails struct {
	value *PaymentWithAccountDetails
	isSet bool
}

func (v NullablePaymentWithAccountDetails) Get() *PaymentWithAccountDetails {
	return v.value
}

func (v *NullablePaymentWithAccountDetails) Set(val *PaymentWithAccountDetails) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentWithAccountDetails) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentWithAccountDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentWithAccountDetails(val *PaymentWithAccountDetails) *NullablePaymentWithAccountDetails {
	return &NullablePaymentWithAccountDetails{value: val, isSet: true}
}
